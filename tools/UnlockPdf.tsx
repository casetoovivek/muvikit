    ...
    return (
        <div className="space-y-6">
            <div className="pb-4 border-b border-gray-200 dark:border-slate-700">
                <h2 className="text-3xl font-bold text-slate-800 dark:text-slate-100">Unlock PDF</h2>
                <p className="mt-1 text-lg text-slate-500 dark:text-slate-400">Remove password protection from a PDF file.</p>
            </div>
